...
import type {
  BrowserSyncCollection,
  StoredBookmark,
  StoredCredential,
  StoredCredentialMetadata,
  StoredDownload,
  StoredExtensionInstall,
  StoredExtensionPackage,
  StoredHistoryEntry,
  StoredProfile,
  StoredRecordingSegment,
  StoredRecordingSession,
  StoredRemoteTab,
  StoredResearchBundleReceipt,
  StoredSitePermission,
  StoredSyncAccount,
  StoredTab,
  StoredTabGroup,
  StoredWalrusMemoryReceipt,
  StoredWindow,
  SyncQueueRecord,
} from "./BrowserDatabaseModels.js";
