/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=GalleryWorkerBindings src/worker-configuration.d.ts` (hash: 9074a7e47aad7766163767ed17cad15e)
// Runtime types generated with workerd@1.20260811.1 2026-08-24 
interface __BaseEnv_GalleryWorkerBindings {
	GALLERY_OBJECTS: R2Bucket;
	PUBLIC_RATE_LIMITER: RateLimit;
	LOCUS_GALLERY_FINGERPRINT: "d1257f8fe1c98e28efeb83b9fa1755cca4e82aa0360391bb73a7b054b161f10d";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
	}
	interface Env extends __BaseEnv_GalleryWorkerBindings {}
}
interface GalleryWorkerBindings extends __BaseEnv_GalleryWorkerBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOCUS_GALLERY_FINGERPRINT">> {}
}
